...
<div class="userRegister">
	...
	<form:form method="post" commandName="asianpaintsRegisterForm" action="${action}">
		<div class="form_field-elements js-recaptcha-captchaaddon">
			...
			<formElement:formInputBox idKey="register.contactNo" labelKey="register.contactNo" path="contactNo" inputCSS="text" mandatory="true"/>
			<formElement:formInputBox idKey="register.dateOfBirth" labelKey="register.dateOfBirth" path="dateOfBirth" inputCSS="text" mandatory="true"/>
