...
<table class="account-profile-data">
	...
	<tr>
		<td><spring:theme code="profile.contactNo" text="Contact No" />:
		</td>
		<td>${fn:escapeXml(customerData.contactNo)}</td>
	</tr>
	<tr>
		<td><spring:theme code="profile.dateOfBirth" text="Date Of Brith" />:
		</td>
		<td>${fn:escapeXml(customerData.dateOfBirth)}</td>
	</tr>
</table>
...
<a class="button" href="update-contactNo"><spring:theme code="text.account.profile.contactNo" text="Update Contact No"/></a>