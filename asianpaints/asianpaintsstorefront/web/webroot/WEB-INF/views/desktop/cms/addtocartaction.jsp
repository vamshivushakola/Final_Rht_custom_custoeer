...
<div id="addonsDiv">
<table>
	<c:forEach items="${product.extras}" var="addons">
			<tr>
...
<form:form method="post" id="addToCartForm" class="add_to_cart_form span-5" action="${addToCartUrl}">
	<c:if test="${product.purchasable}">
		...
		<input type="hidden" id="extras" name="extras" class="extras"  value="">
	</c:if>
    ...
    document.getElementById("extras").value =  checkedAddonVals; 
}
</script>
</form:form>
