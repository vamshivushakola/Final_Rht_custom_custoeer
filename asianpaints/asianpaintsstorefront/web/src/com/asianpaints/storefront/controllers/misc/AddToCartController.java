...
import com.asianpaints.facades.addons.AsianpaintsCartFacade;
import com.asianpaints.facades.forms.AsianpaintsAddToCartForm;
...
public class AddToCartController extends AbstractController
{
	...
	@Resource(name = "asianpaintsCartFacade")
	private AsianpaintsCartFacade asianpaintsCartFacade;
			...
			@Valid final AsianpaintsAddToCartForm form, final BindingResult bindingErrors)
	{
		...
		final List<String> extras = form.getExtras();
		...
		else
		{
			try
			{
				final CartModificationData cartModification = asianpaintsCartFacade.addToCart(code, qty, extras);
