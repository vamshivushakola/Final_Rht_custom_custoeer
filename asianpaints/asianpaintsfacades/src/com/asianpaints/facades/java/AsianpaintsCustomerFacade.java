 ...
 *
 */
package com.asianpaints.facades.java;
...
public class AsianpaintsCustomerFacade extends DefaultCustomerFacade
{
	...
	public void register(final RegisterData registerData) throws DuplicateUidException
	{
		...
		newCustomer.setContactNo(registerData.getContactNo());
