 ...
 *
 */
public class AsianpaintsCommerceAddToCartStrategy extends DefaultCommerceAddToCartStrategy
{
	@Override
	public CommerceCartModification addToCart(final CommerceCartParameter parameter) throws CommerceCartModificationException
	{
		...
		try
		{
			...
			catch (final UnknownIdentifierException e)
			{
				...
				entry.setSelectedExtras(parameter.getCartExtras());
			...
			if (actualAllowedQuantityChange > 0)
			{
				...
				if (deliveryPointOfService == null)
				{
					...
					cartEntryModel.setSelectedExtras(parameter.getCartExtras());
				}
				else
				{
