...
public abstract class GeneratedAsianpaintsSizeVariantProduct extends AsianpaintsStyleVariantProduct
{
	...
	/** Qualifier of the <code>AsianpaintsSizeVariantProduct.extras</code> attribute **/
	...
	static
	{
		...
		tmp.put(EXTRAS, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AsianpaintsSizeVariantProduct.extras</code> attribute.
	 * @return the extras - Extras
	 */
	public List<String> getExtras(final SessionContext ctx)
	{
		List<String> coll = (List<String>)getProperty( ctx, EXTRAS);
	...
	{
		return getExtras( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>AsianpaintsSizeVariantProduct.extras</code> attribute. 
	 * @param value the extras - Extras
	 */
	public void setExtras(final SessionContext ctx, final List<String> value)
	{
		setProperty(ctx, EXTRAS,value == null || !value.isEmpty() ? value : null );
	}
	 ...
	 * @param value the extras - Extras
	 */
	public void setExtras(final List<String> value)
	{
		setExtras( getSession().getSessionContext(), value );
	}
