...
/**
 * This is the extension manager of the Vivocha extension.
 */
public class VivochaManager extends GeneratedVivochaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(VivochaManager.class.getName());
	 ...
	 */
	public static VivochaManager getInstance()
	{
		return (VivochaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				VivochaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public VivochaManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of VivochaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of VivochaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of VivochaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
